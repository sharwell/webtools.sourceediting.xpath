...
MathPlus, MathMinus, MathTimes, MathDiv, MathIDiv, MathMod {
	 ...
	 */
	public static <T extends AnyType> T get_single_type(Item at, Class<? extends T> type) throws DynamicError {
		try {
			return type.cast(at);
	...
	public static <T extends AnyType> T get_single_type(AnyType at, Class<? extends T> type) throws DynamicError {
	 ...
	 *             If node being tested is not of expected type
	 */
	public static <T extends AnyType> T get_single_type(ResultSequence rs, Class<? extends T> type) throws DynamicError {
		if (rs.size() != 1)
			throw DynamicError.throw_type_error();
